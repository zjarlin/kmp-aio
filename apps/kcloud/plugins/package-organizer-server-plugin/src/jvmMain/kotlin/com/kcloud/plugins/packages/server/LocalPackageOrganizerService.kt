...
import com.kcloud.plugins.packages.ManagedPackageItem
import com.kcloud.plugins.packages.PackageOrganizeResult
    ...
    override fun loadSettings(): PackageOrganizerSettings {
        return readKCloudJson(settingsFile) {
            PackageOrganizerSettings(
                ...
                targetDirectory = File(KCloudLocalPaths.pluginDir(PACKAGE_PLUGIN_ID), "organized").absolutePath
            )
        }
    }
    ...
    override fun saveSettings(settings: PackageOrganizerSettings): PackageOrganizerSettings {
        val normalized = settings.copy(
            ...
            targetDirectory = settings.targetDirectory.ifBlank {
                File(KCloudLocalPaths.pluginDir(PACKAGE_PLUGIN_ID), "organized").absolutePath
            }
        )
