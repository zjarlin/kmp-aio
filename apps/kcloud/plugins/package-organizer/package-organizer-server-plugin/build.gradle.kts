...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.plugins.packages.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:plugins:package-organizer:package-organizer-plugin"))
