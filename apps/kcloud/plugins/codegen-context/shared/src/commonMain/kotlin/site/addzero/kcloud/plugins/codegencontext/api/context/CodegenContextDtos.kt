...
data class CodegenContextDetailDto(
    ...
    val kotlinClientTransports: String? = null,
    val cExposeTransports: String? = null,
    val artifactKinds: String? = null,
    val cOutputProjectDir: String? = null,
    val bridgeImplPath: String? = null,
    val keilUvprojxPath: String? = null,
    val keilTargetName: String? = null,
    val keilGroupName: String? = null,
