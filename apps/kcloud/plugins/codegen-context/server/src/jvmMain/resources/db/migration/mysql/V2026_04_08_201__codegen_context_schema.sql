...
INSERT IGNORE INTO codegen_context_field (
    ...
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getDeviceInfo' LIMIT 1), '固件版本', '板子固件版本号。', 0, 'firmwareVersion', 'STRING_ASCII', 0, 0, 8, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getDeviceInfo' LIMIT 1), 'CPU 型号', 'CPU 型号。', 1, 'cpuModel', 'STRING_ASCII', 8, 0, 8, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getDeviceInfo' LIMIT 1), '晶振频率', '晶振频率，单位 Hz。', 2, 'xtalFrequencyHz', 'U32_BE', 16, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getDeviceInfo' LIMIT 1), 'Flash 容量', 'Flash 容量，单位字节。', 3, 'flashSizeBytes', 'U32_BE', 18, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getDeviceInfo' LIMIT 1), 'MAC 地址', 'MAC 地址。', 4, 'macAddress', 'STRING_ASCII', 20, 0, 9, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeIndicatorLights' LIMIT 1), '故障灯', '故障灯开关状态。', 0, 'faultLightOn', 'BOOL_COIL', 0, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeIndicatorLights' LIMIT 1), '运行灯', '运行灯开关状态。', 1, 'runLightOn', 'BOOL_COIL', 1, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '魔术字', '魔术字：0x5A5A5A5A，校验 Flash 数据是否已初始化。', 0, 'magicWord', 'U32_BE', 0, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '端口配置', '24 路端口配置。', 1, 'portConfig', 'BYTE_ARRAY', 2, 0, 24, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '串口参数', '串口参数（波特率、校验位等）。', 2, 'uartParams', 'BYTE_ARRAY', 14, 0, 16, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '从机地址', 'Modbus 从机地址。', 3, 'slaveAddress', 'U8', 22, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '防抖参数', '抖动采样参数（阈值，范围 1-255，推荐 5）。', 4, 'debounceParams', 'BYTE_ARRAY', 23, 0, 4, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '帧间隔', 'Modbus 帧时间间隔，单位 ms。', 5, 'modbusInterval', 'U16', 25, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '看门狗使能', '看门狗硬件使能，0 表示关闭，1 表示开启。', 6, 'wdtEnable', 'U8', 26, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '固件升级标志', '固件升级标志，0 表示不升级，1 表示升级。', 7, 'firmwareUpgrade', 'U8', 27, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), 'DI 硬件固件版本', 'DI 模块硬件固件版本号，低 8 位为次版本号，高 8 位为主版本号。', 8, 'diHardwareFirmware', 'BYTE_ARRAY', 28, 0, 2, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), 'DI 状态', '24 路 DI 状态，每个 bit 代表 1 路，bit[0] = CH1。', 9, 'diStatus', 'BYTE_ARRAY', 29, 0, 3, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), '故障状态', '故障状态标志，位掩码。', 10, 'faultStatus', 'U8', 31, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'getFlashConfig' LIMIT 1), 'CRC', 'CRC16 校验，从 magicWord 到 diStatus 字段。', 11, 'crc', 'U16', 32, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '魔术字', '魔术字：0x5A5A5A5A，校验 Flash 数据是否已初始化。', 0, 'magicWord', 'U32_BE', 0, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '端口配置', '24 路端口配置。', 1, 'portConfig', 'BYTE_ARRAY', 2, 0, 24, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '串口参数', '串口参数（波特率、校验位等）。', 2, 'uartParams', 'BYTE_ARRAY', 14, 0, 16, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '从机地址', 'Modbus 从机地址。', 3, 'slaveAddress', 'U8', 22, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '防抖参数', '抖动采样参数（阈值，范围 1-255，推荐 5）。', 4, 'debounceParams', 'BYTE_ARRAY', 23, 0, 4, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '帧间隔', 'Modbus 帧时间间隔，单位 ms。', 5, 'modbusInterval', 'U16', 25, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '看门狗使能', '看门狗硬件使能，0 表示关闭，1 表示开启。', 6, 'wdtEnable', 'U8', 26, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '固件升级标志', '固件升级标志，0 表示不升级，1 表示升级。', 7, 'firmwareUpgrade', 'U8', 27, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), 'DI 硬件固件版本', 'DI 模块硬件固件版本号，低 8 位为次版本号，高 8 位为主版本号。', 8, 'diHardwareFirmware', 'BYTE_ARRAY', 28, 0, 2, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), 'DI 状态', '24 路 DI 状态，每个 bit 代表 1 路，bit[0] = CH1。', 9, 'diStatus', 'BYTE_ARRAY', 29, 0, 3, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), '故障状态', '故障状态标志，位掩码。', 10, 'faultStatus', 'U8', 31, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00'),
    ((SELECT id FROM codegen_context_schema WHERE method_name = 'writeFlashConfig' LIMIT 1), 'CRC', 'CRC16 校验，从 magicWord 到 diStatus 字段。', 11, 'crc', 'U16', 32, 0, 1, NULL, NULL, '2026-04-08 00:00:00', '2026-04-08 00:00:00');
