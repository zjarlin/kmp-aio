...
import com.kcloud.ui.screens.SshWorkspaceScreen
...
private val sshPluginModule = module {
    singleOf(::SshPlugin) withOptions {
        bind<KCloudPlugin>()
    }
}

object SshPluginBundle : KCloudPluginBundle {
    override val koinModules = listOf(sshPluginModule)
}
