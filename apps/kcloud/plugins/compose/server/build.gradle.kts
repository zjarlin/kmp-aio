...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.features.compose.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:plugins:compose:client"))
            implementation(project(":apps:kcloud:plugins:server-management:client"))
