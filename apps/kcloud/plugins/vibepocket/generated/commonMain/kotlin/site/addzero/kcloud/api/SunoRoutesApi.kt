 ...
 */
    @GET("/api/suno/tasks")    suspend fun listTasks(): site.addzero.kcloud.vibepocket.dto.TaskListResult
 ...
 */
    @GET("/api/suno/tasks/{taskId}")    suspend fun readTask(
 ...
 * 返回类型: site.addzero.kcloud.vibepocket.dto.TaskResult
 */
    @POST("/api/suno/generate")    suspend fun generateMusic(
 ...
 * 返回类型: kotlin.String
 */
    @POST("/api/suno/callback/{kind}")    suspend fun handleSunoCallback(
