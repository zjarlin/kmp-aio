 ...
 */
    @GET    suspend fun getFavorites(): kotlin.collections.List<site.addzero.kcloud.vibepocket.routes.FavoriteResponse>
 ...
 */
    @DELETE("/{trackId}")    suspend fun removeFavorite(
