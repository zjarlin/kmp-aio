...
import com.kcloud.features.environment.EnvironmentExecutionResult
import com.kcloud.features.environment.EnvironmentHostInfo
...
private const val ENVIRONMENT_FEATURE_ID = "environment"
...
internal class FileEnvironmentSettingsStore : EnvironmentSettingsStore {
    private val settingsFile = File(KCloudLocalPaths.featureDir(ENVIRONMENT_FEATURE_ID), "settings.json")
