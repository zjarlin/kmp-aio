...
val generatedApiOutputDir = rootDir
    .resolve("apps/kcloud/plugins/system/knowledge-base/shared")
    .resolve("generated/commonMain/kotlin/site/addzero/kcloud/plugins/system/knowledgebase/api")
    .absolutePath
...
ksp {
    arg("apiClientPackageName", "site.addzero.kcloud.plugins.system.knowledgebase.api")
