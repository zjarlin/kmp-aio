...
tasks.matching { task ->
    ...
    doFirst {
        file("$buildDir/kspCaches/jvm/jvmMain/symbols").mkdirs()
        file("$buildDir/kspCaches/jvm/jvmMain/sourceToOutputs").mkdirs()
        file("$buildDir/kspCaches/jvm/jvmMain/classpath").mkdirs()
    }
}
