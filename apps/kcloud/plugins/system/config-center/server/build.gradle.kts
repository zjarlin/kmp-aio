...
val generatedApiOutputDir = project(":apps:kcloud:plugins:system:config-center")
    .projectDir
    .resolve("generated/commonMain/kotlin/site/addzero/kcloud/plugins/system/configcenter/api")
    .absolutePath
...
ksp {
    arg("apiClientPackageName", "site.addzero.kcloud.plugins.system.configcenter.api")
