 ...
 * 板卡基础信息。
 */
data class DeviceBoardInfo(
    /** 板子固件版本号。 */
    @ModbusField(codec = ModbusCodec.STRING_UTF8, registerOffset = 0, length = 8)
    val firmwareVersion: String,
    /** CPU 型号。 */
    @ModbusField(codec = ModbusCodec.STRING_UTF8, registerOffset = 8, length = 8)
    val cpuModel: String,
    /** 晶振频率，单位 Hz。 */
