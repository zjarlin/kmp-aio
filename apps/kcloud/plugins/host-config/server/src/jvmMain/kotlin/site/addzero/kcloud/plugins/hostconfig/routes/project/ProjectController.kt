...
import site.addzero.kcloud.plugins.hostconfig.routes.project.DeviceCreateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.DevicePositionUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.DeviceResponse
import site.addzero.kcloud.plugins.hostconfig.routes.project.DeviceUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.LinkExistingProtocolRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ModuleCreateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ModulePositionUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ModuleResponse
import site.addzero.kcloud.plugins.hostconfig.routes.project.ModuleUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProjectCreateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProjectPositionUpdateRequest
...
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProjectUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProtocolCatalogItemResponse
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProtocolCreateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProtocolPositionUpdateRequest
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProtocolResponse
import site.addzero.kcloud.plugins.hostconfig.routes.project.ProtocolUpdateRequest
