...
object DeviceTypeFormProps {
    ...
    fun getAllFields(): List<String> {
        return listOf("createdAt", "updatedAt", "code", "name", "description", "sortIndex")
    }
}

@Composable
fun DeviceTypeForm(
    state: MutableState<DeviceTypeIso>,
    visible: Boolean,
    title: String,
    onClose: () -> Unit,
    onSubmit: () -> Unit,
    confirmEnabled: Boolean = true,
    dslConfig: DeviceTypeFormDsl.() -> Unit = {}
) {
    AddDrawer(
        visible = visible,
        title = title,
        ...
        DeviceTypeFormOriginal(state, dslConfig)
    }
}

@Composable
fun DeviceTypeFormOriginal(
    state: MutableState<DeviceTypeIso>,
    dslConfig: DeviceTypeFormDsl.() -> Unit = {}
) {
    val renderMap = remember { mutableMapOf<String, @Composable () -> Unit>() }
    val dsl = DeviceTypeFormDsl(state, renderMap).apply(dslConfig)
    val defaultRenderMap = linkedMapOf<String, @Composable () -> Unit>(
        DeviceTypeFormProps.createdAt to {
            AddTextField(
        ...
        DeviceTypeFormProps.updatedAt to {
            AddTextField(
        ...
        DeviceTypeFormProps.description to {
            AddTextField(
        ...
        DeviceTypeFormProps.sortIndex to {
            AddTextField(
...
class DeviceTypeFormDsl(
    val state: MutableState<DeviceTypeIso>,
    ...
    fun createdAt(
        ...
        order: Int? = null,
        render: (@Composable (MutableState<DeviceTypeIso>) -> Unit)? = null
    ) {
        when {
            hidden -> {
    ...
    fun insertBefore(targetField: String, vararg newFields: String) {
        if (fieldOrder.isEmpty()) {
            fieldOrder.addAll(DeviceTypeFormProps.getAllFields())
        }
    ...
    private fun updateFieldOrder(fieldName: String, orderValue: Int) {
        ...
        val allFields = DeviceTypeFormProps.getAllFields()
...
@Composable
fun rememberDeviceTypeFormState(current: DeviceTypeIso? = null): MutableState<DeviceTypeIso> {
    return remember(current) { mutableStateOf(current ?: DeviceTypeIso()) }
}