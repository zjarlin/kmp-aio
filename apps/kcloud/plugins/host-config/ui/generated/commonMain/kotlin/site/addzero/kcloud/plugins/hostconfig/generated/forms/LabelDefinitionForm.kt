...
object LabelDefinitionFormProps {
    ...
    fun getAllFields(): List<String> {
        return listOf("createdAt", "updatedAt", "code", "name", "description", "colorHex", "sortIndex", "productLinks")
    }
}
    ...
    val defaultRenderMap = linkedMapOf<String, @Composable () -> Unit>(
        ...
        LabelDefinitionFormProps.colorHex to {
            AddTextField(
                ...
                onValueChange = {
                    state.value = state.value.copy(colorHex = if (it.isNullOrEmpty()) null else it.parseObjectByKtx())
                },
                label = "colorHex",
                isRequired = false
            )
        ...
        LabelDefinitionFormProps.productLinks to {
            AddTextField(
                ...
                onValueChange = {
                    state.value = state.value.copy(productLinks = if (it.isNullOrEmpty()) "" else it.parseObjectByKtx())
                },
                label = "productLinks",
                isRequired = true
            )
...
class LabelDefinitionFormDsl(
    ...
    fun colorHex(
        ...
        order?.let { orderValue ->
            updateFieldOrder("colorHex", orderValue)
        }
    }
    ...
    fun productLinks(
        ...
        order?.let { orderValue ->
            updateFieldOrder("productLinks", orderValue)
        }
    }
    ...
    fun insertBefore(targetField: String, vararg newFields: String) {
        if (fieldOrder.isEmpty()) {
            fieldOrder.addAll(LabelDefinitionFormProps.getAllFields())
        }
