...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.plugins.transferhistory.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:plugins:transfer-history:transfer-history-plugin"))
