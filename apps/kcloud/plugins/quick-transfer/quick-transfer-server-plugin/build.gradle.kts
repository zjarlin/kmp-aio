...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.plugins.quicktransfer.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:plugins:quick-transfer:quick-transfer-plugin"))
