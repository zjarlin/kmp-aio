...
import com.kcloud.features.webdav.WebDavActionResult
import com.kcloud.features.webdav.WebDavConnectionConfig
import com.kcloud.features.webdav.WebDavEntry
...
private const val WEBDAV_FEATURE_ID = "webdav"

@Single
class WebDavWorkspaceServiceImpl : WebDavWorkspaceService {
    private val settingsFile = File(KCloudLocalPaths.featureDir(WEBDAV_FEATURE_ID), "settings.json")
