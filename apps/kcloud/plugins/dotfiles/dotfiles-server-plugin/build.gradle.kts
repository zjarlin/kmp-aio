...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.plugins.dotfiles.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:plugins:dotfiles:dotfiles-plugin"))
