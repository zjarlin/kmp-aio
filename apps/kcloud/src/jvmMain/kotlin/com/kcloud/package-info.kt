 ...
 *
 * ### 初始化顺序
 * 1. 数据库 (SQLite) - [com.kcloud.db.Database]
 * 2. 存储客户端 (S3/SSH) - [com.kcloud.features.servermanagement.server.storage.S3StorageClient], [com.kcloud.storage.SSHStorageClient]
 ...
 * 7. 全局快捷键 - [com.kcloud.features.desktop.system.GlobalShortcutManagerInstance]
 * 8. 系统托盘 - [com.kcloud.system.EnhancedTrayManager]
 * 9. UI 窗口管理 - [com.kcloud.features.desktop.system.WindowManager]
 *
 * ### 资源清理
