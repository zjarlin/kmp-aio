...
import site.addzero.kcloud.app.render.sidebarFrame
import site.addzero.kcloud.app.render.statusBarFrame
import site.addzero.kcloud.app.render.visibleLeafCount
...
class KCloudSidebarRenderer(
    ...
    private val shellState: site.addzero.kcloud.app.KCloudShellState,
...
private fun rememberSelectedNode(
    screenCatalog: ScreenCatalog,
    shellState: site.addzero.kcloud.app.KCloudShellState,
): ScreenNode? {
