...
object KCloudUiPresets {
    val Comfortable = KCloudUiMetrics()

    val DesktopCompact = KCloudUiMetrics(
        compact = true,
        topBarHeight = 48.dp,
...
val LocalKCloudUiMetrics = staticCompositionLocalOf { KCloudUiPresets.Comfortable }

@Composable
fun currentKCloudUiMetrics(): KCloudUiMetrics = LocalKCloudUiMetrics.current
