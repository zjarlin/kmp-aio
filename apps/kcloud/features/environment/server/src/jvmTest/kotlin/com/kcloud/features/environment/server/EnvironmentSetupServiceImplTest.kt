...
import com.kcloud.features.environment.EnvironmentInstallTarget
import com.kcloud.features.environment.EnvironmentPackage
...
class EnvironmentSetupServiceImplTest {
    ...
    fun `previewInstall configures official docker apt repository`() {
        ...
        assertContains(result.script, "run_root apt-get install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-client")
    ...
    fun `previewInstall configures official docker dnf repository`() {
        ...
        assertContains(result.script, "run_root dnf install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-client")
    }
    ...
    fun `previewInstall configures official docker yum repository`() {
        ...
        assertContains(result.script, "download.docker.com/linux/\$docker_repo_os/docker-ce.repo")
        assertContains(result.script, "run_root yum install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-client")
    }
}
