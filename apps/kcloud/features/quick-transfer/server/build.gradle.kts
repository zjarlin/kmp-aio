...
ksp {
    arg("springKtor.generatedPackage", "com.kcloud.features.quicktransfer.server.generated.springktor")
}
...
kotlin {
    sourceSets {
        jvmMain.dependencies {
            ...
            implementation(project(":apps:kcloud:features:quick-transfer:client"))
