package com.kcloud.features.servermanagement.server.storage
...
import com.kcloud.sync.api.DownloadResult
import com.kcloud.sync.api.RemoteObject
import com.kcloud.sync.api.StorageClient
import com.kcloud.sync.api.UploadResult
...
data class S3Config(
    ...
    val prefix: String = "",        // 存储前缀（如: "kcloud/"）
