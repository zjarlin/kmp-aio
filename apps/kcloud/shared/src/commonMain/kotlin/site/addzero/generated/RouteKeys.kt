...
object RouteKeys {
    ...
    val allMeta = listOf(
        ...
        Route(value = "权限中心", title = "RBAC权限管理", routePath = "system/rbac", icon = "AdminPanelSettings", order = 20.0, placement = RoutePlacement(scene = RouteScene(name = "系统", icon = "AdminPanelSettings", order = 100), defaultInScene = true), qualifiedName = "site.addzero.kcloud.plugins.rbac.screen.RbacUserScreen", simpleName = "RbacUserScreen"),
