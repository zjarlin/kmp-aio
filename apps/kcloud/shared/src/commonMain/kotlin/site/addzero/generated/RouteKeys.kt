...
object RouteKeys {
    ...
    val allMeta = listOf(
        ...
        Route(value = "配置中心", title = "配置项", routePath = "system/config-center/value", icon = "Key", order = 80.0, placement = RoutePlacement(scene = RouteScene(name = "系统管理", icon = "AdminPanelSettings", order = 100), defaultInScene = false), qualifiedName = "site.addzero.kcloud.plugins.system.configcenter.screen.ConfigCenterProjectsScreen", simpleName = "ConfigCenterProjectsScreen")
    )
}
