#!/usr/bin/env python3
"""
KCloud Nautilus (GNOME Files) Extension

安装:
    cp kcloud_extension.py ~/.local/share/nautilus-python/extensions/
    或
    sudo cp kcloud_extension.py /usr/share/nautilus-python/extensions/
...
SOCKET_PATH = os.path.expanduser("~/.kcloud/ipc.sock")
...
class KCloudExtension(GObject.GObject, Nautilus.MenuProvider, Nautilus.InfoProvider):
    """KCloud Nautilus 扩展"""

    def __init__(self):
        self.ipc = IPCClient()
        self.sync_root = os.path.expanduser("~/KCloud")
