...
class BuiltinTemplateCatalog {
    val templates: List<BuiltinTemplateSpec> = listOf(
        ...
        BuiltinTemplateSpec(
            ...
            scope = BuiltinTemplateScope.ENTITY,
            outputKind = TemplateOutputKind.KOTLIN_SOURCE,
            relativeOutputPath = "plugins/{{contextCode}}/server/src/main/kotlin/{{packagePath}}/dto",
        ...
        BuiltinTemplateSpec(
            ...
            scope = BuiltinTemplateScope.CONTEXT,
            outputKind = TemplateOutputKind.KOTLIN_SOURCE,
            relativeOutputPath = "plugins/{{contextCode}}/client/src/commonMain/kotlin/{{packagePath}}/client",
            fileNameTemplate = "{{ContextName}}ClientFeature.kt",
            body = "builtin:client-placeholder",
        ),
        BuiltinTemplateSpec(
