...
object RouteKeys {
     ...
     */
    val allMeta = listOf(
        Route(value = "环境资产", title = "环境资产管理", routePath = "tools/storage-tool", icon = "Inventory2", order = 10.0, placement = RoutePlacement(scene = RouteScene(name = "工具箱", icon = "Inventory2", order = 200), defaultInScene = true), qualifiedName = "site.addzero.kbox.plugins.tools.storagetool.screen.KboxStorageToolScreen", simpleName = "KboxStorageToolScreen"),
