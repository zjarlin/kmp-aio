...
if (localAddzeroLibJvmDir.resolve("settings.gradle.kts").isFile) {
    ...
    remapExternalProject(":lib:ksp:common:ksp-support", "lib/ksp/common/ksp-support")
    ...
    gradle.beforeProject {
        configurations.configureEach {
            resolutionStrategy.dependencySubstitution {
                ...
                substitute(module("site.addzero:ksp-support"))
                    .using(project(":lib:ksp:common:ksp-support"))
