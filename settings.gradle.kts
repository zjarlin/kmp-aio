...
if (hasLocalAddzeroLibJvm) {
    ...
    remapExternalProject(":lib:compose:compose-workbench-immersive-desktop", "lib/compose/compose-workbench-immersive-desktop")
    ...
    remapExternalProject(":lib:tool-kmp:tool-expect", "lib/tool-kmp/tool-expect")
    remapExternalProject(":lib:tool-kmp:tool-json", "lib/tool-kmp/tool-json")
    remapExternalProject(":lib:tool-kmp:tool-koin", "lib/tool-kmp/tool-koin")
    ...
    remapExternalProject(":lib:tool-jvm:database:tool-sql-executor", "lib/tool-jvm/database/tool-sql-executor")
    ...
    gradle.beforeProject {
        configurations.configureEach {
            resolutionStrategy.dependencySubstitution {
                ...
                substitute(module("site.addzero:compose-workbench-immersive-desktop"))
                    .using(project(":lib:compose:compose-workbench-immersive-desktop"))
                ...
                substitute(module("site.addzero:tool-expect"))
                    .using(project(":lib:tool-kmp:tool-expect"))
                substitute(module("site.addzero:tool-json"))
                    .using(project(":lib:tool-kmp:tool-json"))
                substitute(module("site.addzero:tool-koin"))
                    .using(project(":lib:tool-kmp:tool-koin"))
                ...
                substitute(module("site.addzero:tool-sql-executor"))
                    .using(project(":lib:tool-jvm:database:tool-sql-executor"))
